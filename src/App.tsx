...
export default function App() {
	...
	return (
		<div className="h-dvh bg-bg">
			<div className="relative mx-auto flex h-full max-w-md flex-col overflow-x-hidden">
				{/* Header */}
				<div className="flex items-center justify-between border-b border-border px-4 py-3">
					<h1 className="text-lg font-semibold text-text font-['Poppins']">{PageTitle({ tab })}</h1>
				</div>
				...
				{/* Bottom Navigation */}
				<BottomNav activeTab={tab} onChange={(id) => appStore.setTab(id as AppTab)} />
			</div>
		</div>
	);
}
